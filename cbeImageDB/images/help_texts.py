...
experiment_name = """An experiment is all the images performed on a single set of samples. All images associated with a single set of samples should be uploaded under the same experiment.  The experiment name allows it to be looked up later under the search under experiments tab. Images can be uploaded to an existing experiment."""
experiment_project = """The project encompasses a related set of images and experiments, such as all the images associated with a paper. If you do not see your project, you can simply add one by clicking create while uploading an image."""
...
image_imager = """The person who took the image. If you do not see the imager’s name, you may add it while uploading an image."""
